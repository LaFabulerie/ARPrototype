...
{
	public class UIAugmentedImageLandscape : MonoBehaviour
	{
		private GameObject returnButtonObj_;
		...
		private void OnDrag(Vector2 pos_)
		{
			...
			var ray_ = arCoreDeviceC_.ScreenPointToRay(pos_);
		...
		private void Start()
		{
			returnButtonObj_ = transform.Find("UIButton-Return").gameObject;
			var returnButtonRT_ = returnButtonObj_.GetComponent<RectTransform>();

			//returnButtonRT_.offsetMax = new Vector2(0f, 98f * UICanvasScaler.Scale_);
